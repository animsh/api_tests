...
from .views import ListUserView, CreateUserView, StorageEncodeView, ListStorageEncodeView, SingleStorageEncodeView, StorageDecodeView, SingleStorageDecodeView, StorageReceiveView

urlpatterns = [
    path('users', ListUserView.as_view(), name="users-all"),
    path('users/signup', CreateUserView.as_view(), name="users-create"),
    path('users/encodedfiles', ListStorageEncodeView.as_view(), name="storage-encode-all"),
