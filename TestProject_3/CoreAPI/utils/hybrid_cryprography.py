...
def encrypt_file(hidden_file, public_key, user_id, storage_id, cover_file_type, cover_file):
    """
...
def decrypt_file(userid, encoded_file, encrypted_password, private_key, storage_id):
    """
